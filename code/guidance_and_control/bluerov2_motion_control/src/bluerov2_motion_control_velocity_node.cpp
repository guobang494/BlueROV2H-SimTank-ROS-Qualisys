...
int main(int argc, char** argv)
{
  ...
  std::vector<Axis> axes = {
    {"bluerov2_motion_control_vel",   "PID_u1_velocity",   "/bluerov2_heavy/velocity_body_frame/linear/x",    "/bluerov2_heavy/reference_velocity/linear/x",    "/bluerov2_heavy/cmd_wrench/linear/x"},
    {"bluerov2_motion_control_vel",   "PID_u2_velocity",   "/bluerov2_heavy/velocity_body_frame/linear/y",    "/bluerov2_heavy/reference_velocity/linear/y",    "/bluerov2_heavy/cmd_wrench/linear/y"},
    {"bluerov2_motion_control_vel",   "PID_u3_velocity",   "/bluerov2_heavy/velocity_body_frame/linear/z",    "/bluerov2_heavy/reference_velocity/linear/z",    "/bluerov2_heavy/cmd_wrench/linear/z"},
    {"bluerov2_motion_control_vel", "PID_u4_velocity", "/bluerov2_heavy/velocity_body_frame/angular/x", "/bluerov2_heavy/reference_velocity/angular/x",  "/bluerov2_heavy/cmd_wrench/angular/x"},
    {"bluerov2_motion_control_vel", "PID_u5_velocity", "/bluerov2_heavy/velocity_body_frame/angular/y", "/bluerov2_heavy/reference_velocity/angular/y",  "/bluerov2_heavy/cmd_wrench/angular/y"},
    {"bluerov2_motion_control_vel", "PID_u6_velocity", "/bluerov2_heavy/velocity_body_frame/angular/z", "/bluerov2_heavy/reference_velocity/angular/z",  "/bluerov2_heavy/cmd_wrench/angular/z"}
